...
class UnitReportDetails extends StatefulWidget{
  _ScreenState createState()=>_ScreenState();
}

class _ScreenState extends State<UnitReportDetails>{
          ...
          actions: [
            ...
            if(Helper.hasPrivilege(context.read<UserBloc>().loggedInUser!.designation,UserField.UNIT))
              IconButton(
                ...
                onPressed: ()async{
                  Helper.navigate(context, Screens.ADD_UNIT_REPORT, arguments: ReportArguments<UnitReport>(
                      isUpdate: true,
                      report: args!.report!
                  ));
                },
          ...
          child: BlocConsumer<ReportBloc,ReportState>(
            builder: (context, state){
              ...
              if(  state is DeleteReportState){
                return LoadingWidget(message: 'Deleting Report',);
              }
