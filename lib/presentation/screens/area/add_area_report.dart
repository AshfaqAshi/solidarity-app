...
class AddAreaReportScreen extends ScaffoldBase{
  _ScreenState createState()=>_ScreenState();
}

class _ScreenState extends ScaffoldBaseState<AddAreaReportScreen>{
  ...
  String title()=>args!=null?'Update Report':'Add new Unit Report';
  ...
  void initState(){
    ...
    reportBloc.add(GetFieldsEvent(ReportType.AREA));
  }
  ...
  Widget body(){
    ...
    return  BlocConsumer<ReportBloc,ReportState>(
                        ...
                        onClick: (){
                          if(_formKey.currentState!.validate()){
                            ...
                            if(args!.isUpdate){
                              ...
                              args!.report!.areaId = areaBloc.selectedArea!.id;
                              ...
                              AreaReport report = AreaReport(
                                  areaId: areaBloc.selectedArea!.id,
                                  report: Report(
            ...
            listener: (context, state){
              ...
              }else if(state is DeleteReportCompleteState){
                if(state.result.success){
